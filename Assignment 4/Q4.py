...
def importTrainingdata():
    Training_data = pd.read_csv(r'C:\Users\Deepika\Downloads\studies\data mining\homework4\PB4_train.csv',
...
def importTestdata():
    Test_data = pd.read_csv(r'C:\Users\Deepika\Downloads\studies\data mining\homework4\PB4_test.csv',
                            names=['Height', 'Age', 'Weight', 'Class'])
    #    print(Test_data)
    #    # Printing the dataswet shape
